...
namespace AzureDevOps.RestAPI.NetSDK.Helper.AzdoWiki.Extensions
{
    public static class WikiExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<string> GetWikiPageText(this VssConnection connection, string project, string wikiIdentifier, string path)
        {
            var client = connection.GetClient<WikiHttpClient>();
